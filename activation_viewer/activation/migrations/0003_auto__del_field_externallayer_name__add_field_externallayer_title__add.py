...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ExternalLayer.name'
        db.delete_column(u'activation_externallayer', 'name')

        # Adding field 'ExternalLayer.title'
        db.add_column(u'activation_externallayer', 'title',
                      self.gf('django.db.models.fields.CharField')(default='test', max_length=128),
                      keep_default=False)

        # Adding field 'ExternalLayer.layer_name'
        db.add_column(u'activation_externallayer', 'layer_name',
                      self.gf('django.db.models.fields.CharField')(default='test', max_length=128),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ExternalLayer.name'
        db.add_column(u'activation_externallayer', 'name',
                      self.gf('django.db.models.fields.CharField')(default='test', max_length=128),
                      keep_default=False)

        # Deleting field 'ExternalLayer.title'
        db.delete_column(u'activation_externallayer', 'title')

        # Deleting field 'ExternalLayer.layer_name'
        db.delete_column(u'activation_externallayer', 'layer_name')
    ...
    models = {
        ...
        u'activation.externallayer': {
            'Meta': {'object_name': 'ExternalLayer'},
            'activation': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['activation.Activation']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'layer_name': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
