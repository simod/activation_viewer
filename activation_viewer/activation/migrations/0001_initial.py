...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DisasterType'
        db.create_table(u'activation_disastertype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50)),
        ))
        db.send_create_signal(u'activation', ['DisasterType'])

        # Adding model 'MapSet'
        db.create_table(u'activation_mapset', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('activation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['activation.Activation'])),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50)),
        ))
        db.send_create_signal(u'activation', ['MapSet'])

        # Adding model 'Activation'
        db.create_table(u'activation_activation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('activation_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=7)),
            ...
            ('glide_number', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('disaster_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['activation.DisasterType'])),
            ('event_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('event_time_utc', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('activation_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'activation', ['Activation'])

        # Adding M2M table for field regions on 'Activation'
        m2m_table_name = db.shorten_name(u'activation_activation_regions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('activation', models.ForeignKey(orm[u'activation.activation'], null=False)),
            ('region', models.ForeignKey(orm[u'base.region'], null=False))
        ))
        db.create_unique(m2m_table_name, ['activation_id', 'region_id'])

        # Adding model 'MapProduct'
        db.create_table(u'activation_mapproduct', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('map_set', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['activation.MapSet'])),
            ('service_level', self.gf('django.db.models.fields.IntegerField')()),
        ...
        db.send_create_signal(u'activation', ['MapProduct'])

        # Adding M2M table for field layers on 'MapProduct'
        m2m_table_name = db.shorten_name(u'activation_mapproduct_layers')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('mapproduct', models.ForeignKey(orm[u'activation.mapproduct'], null=False)),
            ('layer', models.ForeignKey(orm[u'layers.layer'], null=False))
        ))
        db.create_unique(m2m_table_name, ['mapproduct_id', 'layer_id'])


    def backwards(self, orm):
        # Deleting model 'DisasterType'
        db.delete_table(u'activation_disastertype')

        # Deleting model 'MapSet'
        db.delete_table(u'activation_mapset')

        # Deleting model 'Activation'
        db.delete_table(u'activation_activation')

        # Removing M2M table for field regions on 'Activation'
        db.delete_table(db.shorten_name(u'activation_activation_regions'))

        # Deleting model 'MapProduct'
        db.delete_table(u'activation_mapproduct')

        # Removing M2M table for field layers on 'MapProduct'
        db.delete_table(db.shorten_name(u'activation_mapproduct_layers'))


    models = {
        u'activation.activation': {
            'Meta': {'object_name': 'Activation'},
            'activation_id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '7'}),
            'activation_time': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'disaster_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['activation.DisasterType']"}),
            'event_time': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'event_time_utc': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'glide_number': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
        ...
        u'activation.disastertype': {
            'Meta': {'object_name': 'DisasterType'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50'})
        },
        u'activation.mapproduct': {
            'Meta': {'object_name': 'MapProduct'},
            'bbox_x0': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '19', 'decimal_places': '10', 'blank': 'True'}),
            'bbox_x1': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '19', 'decimal_places': '10', 'blank': 'True'}),
            'bbox_y0': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '19', 'decimal_places': '10', 'blank': 'True'}),
            'bbox_y1': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '19', 'decimal_places': '10', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'layers': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['layers.Layer']", 'null': 'True', 'blank': 'True'}),
            'map_set': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['activation.MapSet']"}),
            'service_level': ('django.db.models.fields.IntegerField', [], {}),
            'type': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        },
        u'activation.mapset': {
            'Meta': {'object_name': 'MapSet'},
            'activation': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['activation.Activation']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50'})
        },
