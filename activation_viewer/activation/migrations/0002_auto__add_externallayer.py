...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExternalLayer'
        db.create_table(u'activation_externallayer', (
        ...
        db.send_create_signal(u'activation', ['ExternalLayer'])


    def backwards(self, orm):
        # Deleting model 'ExternalLayer'
        db.delete_table(u'activation_externallayer')
