...
### REDEFINES MAPPROXY SEEDER USING BILLIARD IN NON DAEMONIC WAY
### THIS ENSURES A SMOOTH INTEGRATION WITH CELERY TASKS
...
import billiard
proc_class = billiard.Process
queue_class = billiard.Queue
